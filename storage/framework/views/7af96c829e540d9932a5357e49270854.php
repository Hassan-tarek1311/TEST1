...
<div class="grid grid-2" style="gap:20px">
    ...
    <div class="card">
        <div class="section-header">
            ...
            <a href="<?php echo e(route('timelogs.index')); ?>" style="font-size:12px; color:var(--accent); text-decoration:none;">View all →</a>
        </div>
        <div id="recentLogs">
...
<div class="card" style="margin-top:20px">
    <div class="section-header">
        ...
        <a href="<?php echo e(route('projects.index')); ?>" style="font-size:12px; color:var(--accent); text-decoration:none;">Manage →</a>
    </div>
