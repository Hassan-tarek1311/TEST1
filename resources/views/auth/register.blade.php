        ...
        <form action="{{ route('register.post') }}" method="POST">
            ...
            <div class="grid-2">
                <div class="form-group">
                    ...
                    <input type="text" name="org_name" class="form-input" placeholder="Acme Corp" value="{{ old('org_name') }}" required>
                </div>
                <div class="form-group">
                    <label class="form-label">Company Email</label>
                    <input type="email" name="org_email" class="form-input" placeholder="info@acme.com" value="{{ old('org_email') }}" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" class="form-input" placeholder="john@acme.com" value="{{ old('email') }}" required>
            </div>
            <div class="grid-2">
                <div class="form-group">
