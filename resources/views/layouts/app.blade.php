...
<head>
    ...
    <title>TimeBee — @yield('title', 'Dashboard')</title>
...
<aside class="sidebar">
    <div class="sidebar-logo">
        ...
        <div class="org-name">{{ auth()->user()?->organization?->name ?? 'Organization' }}</div>
    </div>
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('timelogs.index') }}" class="nav-item {{ request()->routeIs('timelogs.*') ? 'active' : '' }}">
        ...
        @endif
        <a href="{{ route('ai.report') }}" class="nav-item {{ request()->routeIs('ai.*') ? 'active' : '' }}">
...
window.API_TOKEN = @json(session('jwt_token', ''));
